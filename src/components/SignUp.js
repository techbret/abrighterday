              ...
              <div className="relative">
                ...
                <form action="#" className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      type="submit"
                      className="block w-full rounded-md border border-transparent px-5 py-3 bg-amber-500 text-base font-medium text-white shadow hover:bg-amber-400 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-amber-600 sm:px-10"
                    >
                      Sign Up
                    </button>                    
                  </div>
